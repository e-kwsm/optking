...
Simple internal coordinates, corresponding to a zmatrix, can be created through the class constructors if desired; however,
...
The string parsing is more robust and forgiving than in the c++ version. Multiline strings and strange spacing
is allowed.
...
The DimerFrag class creates internal coordinates between pairs of molecules. i.e. the water trimer would 
consist of internal coordinates for A, B, and C as well as dimer coordinates for AB, AC, and BC
...
.. .. autoclass:: optking.stre.Stre
.. .. autoclass:: optking.bend.Bend
.. .. autoclass:: optking.tors.Tors
.. .. autoclass:: optking.oofp.Oofp
.. .. autoclass:: optking.cart.Cart
